...
int main(void) {
  ...
  if (numerator_1 % denominator_1 == 0) {
    printf("%d + ", numerator_1 / denominator_1);
  } else if (numerator_1 > denominator_1) {
    printf("%d.%d/%d + ", numerator_1 / denominator_1, numerator_1 % denominator_1, denominator_1);
  } else {
    printf("%d/%d + ", numerator_1, denominator_1);
  }
  if (numerator_2 % denominator_2 == 0) {
    printf("%d = ", numerator_2 / denominator_2);
  } else if (numerator_2 > denominator_2) {
    printf("%d.%d/%d = ", numerator_2 / denominator_2, numerator_2 % denominator_2, denominator_2);
  } else {
