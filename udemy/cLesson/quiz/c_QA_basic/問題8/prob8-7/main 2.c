...
void main()
{
	...
	if (numerator1 % denominator1 == 0) {
		printf("%d + ", numerator1 / denominator1);
	}else if (numerator1 > denominator1) {
		printf("%d.%d/%d + ", numerator1 / denominator1, numerator1 % denominator1, denominator1);
	} else {
		printf("%d/%d + ", numerator1, denominator1);
	}
	
	if (numerator2 % denominator2 == 0) {
		printf("%d = ", numerator2 / denominator2);
	}
	else if (numerator2 > denominator2) {
		printf("%d.%d/%d = ", numerator2 / denominator2, numerator2 % denominator2, denominator2);
	}
	else {
		printf("%d/%d = ", numerator2, denominator2);
	}
